...
namespace MemMap
{
    public class Crit_FRFCFS : MemSched
    {
        ...
        {
            if (req1.stall_time > req2.stall_time) return req1;
            else if (req2.stall_time > req1.stall_time) return req2;
    ...
    public class Crit_FRFCFS_CAP : MemSched
    {
        //streak
        int[] streak;
