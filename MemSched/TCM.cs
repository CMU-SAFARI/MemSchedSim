...
//            Console.Write (" Req 1: rank " + rank1 + " Req 2: rank " + rank2 + "\n");
            if (rank1 != rank2) {
...
//                print_rank();
            ...
            if (meta_mctrl.get_cycles() % 1000 == 0) {
//                clear_ranking_except_top();
            }
//            else if (shuffle_cycles_left == 0)
//            {
//                clear_ranking_except_top();
//            }
            ...
            Console.Write("Cluster size " + icluster_size + "\n");
            if (icluster_size > 1) assign_nice_rank();
//            if (Config.sched.same_lowint_rank)
//            {
//                make_same_lowint_rank();
//            }
        }
...
//            {
//                Console.Write("Proc " + p + " rank " + rank[p] + "\n");
//            }
            for (int p = 0; p < Config.N; p ++)
            {
        ...
        private int cluster()
        {
            ...
            for (r = Config.N - 1; r >= 0; r--) {
                ...
                Console.Write("Proc " + pid + " Rank " + r + " service " + service[pid] + " total service " + service_total + " cluster factor " + Config.sched.AS_cluster_factor + "\n");
                service_runsum += service[pid];
                if (service_runsum > Config.sched.AS_cluster_factor * service_total)
                    break;
                Console.Write(" LOW INT: Proc " + pid + " Rank " + r + "\n");
                ncluster_size++;
            }
